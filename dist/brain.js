...
(0, cmd_utils_1.logCommandLineArgs)('Brain Agent', cmdArgs);
...
const PERSONA_FILE_PATH = path_1.default.resolve(BRAIN_PERSONA_FILENAME); // Resolve to an absolute path
if (!OPENAI_API_KEY) {
...
// --- Persona Loading ---
let personaContent = 'Default persona: Be helpful and concise.'; // Fallback persona
async function loadPersona() {
    try {
        ...
        personaContent = await promises_1.default.readFile(PERSONA_FILE_PATH, 'utf8');
...
async function startBrainAgent() {
    ...
    const worker = new bullmq_1.Worker(tweetsQueueName, processTweetJob, {
        connection: redisConnectionOptions,
